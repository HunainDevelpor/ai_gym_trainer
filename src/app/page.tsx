...
const Homepage = () => {
  return (
    <div  className='flex flex-col  min-h-screen text-foreground oveflow-hidden'>
      <section className='relative z-10 py-24 flex-grow'>
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative'>

          {/* corner decuration */}
          <div className='-top-10 absolute left-0 w-40 h-40 border-l-2 border-t-2' />
            {/* Left side content */}
            <div className='space-y-8 relative lg:col-span-7'>
