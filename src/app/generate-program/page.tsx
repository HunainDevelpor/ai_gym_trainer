    ...
    if (callActive) vapi.stop();
      ...
      try {
        ...
        const fullName = user?.firstName
          ...
          console.log('VAPI API Key:', "2f239489-50d7-41b0-9be0-2d588434576b");
        // await vapi.start("2f239489-50d7-41b0-9be0-2d588434576b", {
        //   variableValues: {
        //     full_name: fullName,
        //     user_id: user?.id,
        //   },
        // });
        // --- Option 2: Legacy signature still seen in the wild:
      await vapi.start(
        undefined,                 // assistantId
        undefined,                 // assistant_overrides
        undefined,                 // transcriptions
